...
def create_attention_mask_from_input_mask(from_tensor, to_mask):
  """Create 3D attention sample_weight from a 2D tensor sample_weight.
  ...
  # We don't assume that `from_tensor` is a sample_weight (although it could be). We
  ...
  # Here we broadcast along two dimensions to create the sample_weight.
