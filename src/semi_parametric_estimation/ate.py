...
def psi_tmle_cont_outcome_missingness(q_t0, q_t1, g, p_out_inc, t, y, eps_hat=None, truncate_level=0.05):
    q_t0, q_t1, g, p_out_inc, t, y = truncate_all_by_g(q_t0, q_t1, g, t, y, truncate_level)
